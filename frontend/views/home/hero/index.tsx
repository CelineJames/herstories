...
const heroData : heroItems[] = [
    {
        ...
        quote: "I'm a fighter; I'm very focused on what I'm doing, and relentless in what I want to achieve, almost to a fault. If you get in my way, you get kicked.",
    ...
    },
    {
        ...
        quote: "We dont need super heroes, we need real people doing meanifull work.",
        name: "Amel Kabourl",
    },
    {
    ...
    },
    {
        ...
        quote: "My life has been full of struggles, the fight for the emancipation of women...",
        name: "Funmilayo Ransome Kuti",
    },
    {
        image: '/assets/Aoua-keita.jpeg',
        quote: "I wanted to show that a woman too could be a fighter and a builder.",
        name: "Aoua Keita",
    },
    {
    ...
    },
    {
        ...
        quote: "They said 'You are a savage and dangerous woman' i am speaking the truth and the truth is savge and dangerous.",
        name: "Tsitsi Dangaremba",
    },
    // Add more as needed
]
    ...
    return (
        <div className="relative w-full h-[90vh] overflow-hidden mt-16">
            ...
            <Image
                ...
                alt={name}
                fill
                className={`object-fit md:object-cover transition-opacity duration-1000 ease-in-out ${fade ? 'opacity-0' : 'opacity-100'
                    }`}
                priority
            />
            ...
            <div className="absolute inset-0 bg-black/60 flex items-center justify-center px-6 text-center">
                <div
                    className={`text-white max-w-2xl transition-opacity duration-1000 ease-in-out ${fade ? 'opacity-0' : 'opacity-100'
                        }`}
                >
